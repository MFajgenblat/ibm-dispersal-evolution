...
parameter_grid <- expand.grid(species_pool = 1:3,
                              evodisp_scenario = c(1,2),
...
write.table(all_histories, "results_general_scenarios.csv", col.names = T, row.names = F, quote = F, sep = ";")
